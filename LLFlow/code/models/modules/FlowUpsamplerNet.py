...
class FlowUpsamplerNet(nn.Module):
    ...
    def encode(self, gt, rrdbResults, logdet=0.0, epses=None, y_onehot=None):   # self.layer: (1 squeezelayer 14 FlowStep) x 3
        fl_fea = gt
        reverse = False
        level_conditionals = {}
        bypasses = {}
        ...
        for layer, shape in zip(self.layers, self.output_shapes):   # outputshapes:
            size = shape[2]
        ...
        # fl_fea: [16, 3, 160, 160] --> [16, 12, 80, 80] --> [16, 48, 40, 40] --> [16, 192, 20, 20]
        z = fl_fea
