...
class ConEncoder1(nn.Module):
    def __init__(self, in_nc, out_nc, nf, nb, gc=32, scale=4, opt=None):
        ...
        # self.att_block_1 = TransformerBlock()
        # self.att_block_2 = TransformerBlock()
        # self.stt_block_3 = TransformerBlock()
    ...
    def forward(self, x, seg_map, seg_fea, get_steps=False):
        ...
        # fea_down8: [16, 32, 80, 80], fea_down4: [16, 32, 40, 40], fea_down2: [16, 32, 20, 20]
